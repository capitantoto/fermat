...
Estas variables aleatorias se ajustan particularmente bien la #link(<hipotesis-variedad>)[hipótesis de la variedad] planteada al inicio: un elemento aleatorio (el dígito) definido en una variedad que postulamos de baja dimensión, "capturados" en un soporte gráfico de alta dimensión: $d=64$ píxeles para `digitos`, $d=768$ para `mnist`.
